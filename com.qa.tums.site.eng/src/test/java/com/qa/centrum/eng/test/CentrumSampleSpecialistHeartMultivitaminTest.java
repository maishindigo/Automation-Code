...
import com.qa.centrum.eng.pages.CentrumSpecialistHeartMultivitaminPage;

public class CentrumSampleSpecialistHeartMultivitaminTest extends BaseClass{
	
	CentrumSpecialistHeartMultivitaminPage sm;
	...
	private void launchingTheUrl() throws Exception {
		...
		launchURL("https://gskstaging15:Climate2022@centrum-wellness-com.preprod-cf65.ch.adobecqms.net/products/targeted-supplements/specialist-heart-multivitamin/");
		switchingTab(secondTab);
		launchURL("https://www.centrum.com/products/targeted-supplements/specialist-heart-multivitamin/");
	}


	@Test(priority = 0, enabled = true)
	private void cookieButton() throws Exception {
		sm = new CentrumSpecialistHeartMultivitaminPage();
		switchingTab(firstTab);
		sm.clickCookieBtn();
		sm.clickGigyaForm();
		switchingTab(secondTab);
