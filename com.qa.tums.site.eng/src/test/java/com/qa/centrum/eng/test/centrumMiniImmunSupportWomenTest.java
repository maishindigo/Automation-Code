...
public class centrumMiniImmunSupportWomenTest extends BaseClass{
	centrumMiniImmunSupportWomen cm;
	@BeforeClass
	...
	private void launchingTheUrl() throws Exception {
		...
		switchingTab(firstTab);
		launchURL(loadProperties().getProperty("centrumMiniImmunSupportWomenPreprod"));
		switchingTab(secondTab);
		launchURL(loadProperties().getProperty("centrumMiniImmunSupportWomenProd"));
	}
	@Test(priority = 0, enabled = true)
	private void cookieButton() throws Exception {
		cm = new centrumMiniImmunSupportWomen();
		switchingTab(firstTab);
		cm.clickCookieBtn();
