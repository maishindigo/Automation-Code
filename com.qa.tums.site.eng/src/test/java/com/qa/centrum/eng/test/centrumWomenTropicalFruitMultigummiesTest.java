...
import com.qa.centrum.eng.pages.centrumMiniImmunSupportWomen;
import com.qa.centrum.eng.pages.centrumWomenTropicalFruitMultigummies;

public class centrumWomenTropicalFruitMultigummiesTest extends BaseClass {
	centrumWomenTropicalFruitMultigummies cw;
	@BeforeClass
	...
	private void launchingTheUrl() throws Exception {
		...
		switchingTab(firstTab);
		launchURL(loadProperties().getProperty("centrumWomenTropicalFruitPreprod"));
		switchingTab(secondTab);
		launchURL(loadProperties().getProperty("centrumWomenTropicalFruitProd"));
	}
	@Test(priority = 0, enabled = true)
	private void cookieButton() throws Exception {
		cw = new centrumWomenTropicalFruitMultigummies();
		switchingTab(firstTab);
		cw.clickCookieBtn();
