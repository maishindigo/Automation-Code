...
import com.qa.centrum.eng.pages.CentrumMultigummiesMenPage;

public class CenryumSampleMultigummiesMenTest extends BaseClass{
	
	CentrumMultigummiesMenPage mm;
	...
	private void launchingTheUrl() throws Exception {
		...
		launchURL("https://gskstaging15:Climate2022@centrum-wellness-com.preprod-cf65.ch.adobecqms.net/products/multivitamins/centrum-multigummies-men/");
		switchingTab(secondTab);
		launchURL("https://www.centrum.com/products/multivitamins/centrum-multigummies-men/");
	}


	@Test(priority = 0, enabled = true)
	private void cookieButton() throws Exception {
		mm = new CentrumMultigummiesMenPage();
		switchingTab(firstTab);
		mm.clickCookieBtn();
		mm.clickGigyaForm();
		switchingTab(secondTab);
