...
import com.qa.centrum.eng.pages.CentrumVitaminPacksMen20PlusPage;

public class CentrumSampleVitaminPacksMen20PlusTest extends BaseClass{

	CentrumVitaminPacksMen20PlusPage vp;
	...
	private void launchingTheUrl() throws Exception {
		...
		launchURL("https://gskstaging15:Climate2022@centrum-wellness-com.preprod-cf65.ch.adobecqms.net/products/vitamin-packs/men-20-plus/");
		switchingTab(secondTab);
		launchURL("https://www.centrum.com/products/vitamin-packs/men-20-plus/");
	}


	@Test(priority = 0, enabled = true)
	private void cookieButton() throws Exception {
		vp = new CentrumVitaminPacksMen20PlusPage();
		switchingTab(firstTab);
		vp.clickCookieBtn();
		vp.clickGigyaForm();
		switchingTab(secondTab);
