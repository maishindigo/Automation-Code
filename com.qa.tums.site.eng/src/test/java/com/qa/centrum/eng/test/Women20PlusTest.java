...
import com.qa.centrum.eng.pages.Women20Plus;

public class Women20PlusTest extends BaseClass {
	Women20Plus wp;
	@BeforeClass
	...
	private void launchingTheUrl() throws Exception {
		...
		switchingTab(firstTab);
		launchURL(loadProperties().getProperty("Women20PlusPreprod"));
		switchingTab(secondTab);
		launchURL(loadProperties().getProperty("Women20PlusProd"));
	}
