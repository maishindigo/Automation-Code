...
import com.qa.centrum.eng.pages.CentrumAdultGummyRestRejuvenatePage;

public class CentrumSampleAdultGummyRestRejuvenateTest extends BaseClass{
	
	CentrumAdultGummyRestRejuvenatePage ca;
	...
	private void launchingTheUrl() throws Exception {
		...
		launchURL("https://gskstaging15:Climate2022@centrum-wellness-com.preprod-cf65.ch.adobecqms.net/products/targeted-supplements/centrum-adult-gummy-rest-rejuvenate/");
		switchingTab(secondTab);
		launchURL("https://www.centrum.com/products/targeted-supplements/centrum-adult-gummy-rest-rejuvenate/");
	}


	@Test(priority = 0, enabled = true)
	private void cookieButton() throws Exception {
		ca = new CentrumAdultGummyRestRejuvenatePage();
		switchingTab(firstTab);
		ca.clickCookieBtn();
		ca.clickGigyaForm();
		switchingTab(secondTab);
