...
public class CentrumSampleVitaminPacksWomen40PlusTest extends BaseClass{

	
	CentrumVitaminPacksWomen40PlusPage vp;
	...
	private void launchingTheUrl() throws Exception {
		...
		launchURL("https://gskstaging15:Climate2022@centrum-wellness-com.preprod-cf65.ch.adobecqms.net/products/vitamin-packs/women-40-plus/");
		switchingTab(secondTab);
		launchURL("https://www.centrum.com/products/vitamin-packs/women-40-plus/");
	}


	@Test(priority = 0, enabled = true)
	private void cookieButton() throws Exception {
		vp = new CentrumVitaminPacksWomen40PlusPage();
		switchingTab(firstTab);
		vp.clickCookieBtn();
		vp.clickGigyaForm();
		switchingTab(secondTab);
