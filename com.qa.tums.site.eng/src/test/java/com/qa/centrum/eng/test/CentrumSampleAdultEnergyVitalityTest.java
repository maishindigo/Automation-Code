...
import com.qa.centrum.eng.pages.CentrumAdultEnergyVitalityPage;

public class CentrumSampleAdultEnergyVitalityTest extends BaseClass{
	
	CentrumAdultEnergyVitalityPage ca;
	...
	private void launchingTheUrl() throws Exception {
		...
		launchURL("https://gskstaging15:Climate2022@centrum-wellness-com.preprod-cf65.ch.adobecqms.net/products/targeted-supplements/centrum-adult-energy-vitality/");
		switchingTab(secondTab);
		launchURL("https://www.centrum.com/products/targeted-supplements/centrum-adult-energy-vitality/");
	}


	@Test(priority = 0, enabled = true)
	private void cookieButton() throws Exception {
		ca = new CentrumAdultEnergyVitalityPage();
		switchingTab(firstTab);
		ca.clickCookieBtn();
		ca.clickGigyaForm();
		switchingTab(secondTab);
