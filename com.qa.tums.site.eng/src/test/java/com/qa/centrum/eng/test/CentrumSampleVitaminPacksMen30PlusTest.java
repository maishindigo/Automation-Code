...
import com.qa.centrum.eng.pages.CentrumVitaminPacksMen30PlusPage;
import com.qa.centrum.eng.pages.CentrumVitaminPacksWomen40PlusPage;

public class CentrumSampleVitaminPacksMen30PlusTest extends BaseClass{

	CentrumVitaminPacksMen30PlusPage vp;
	...
	private void launchingTheUrl() throws Exception {
		...
		launchURL("https://gskstaging15:Climate2022@centrum-wellness-com.preprod-cf65.ch.adobecqms.net/products/vitamin-packs/men-30-plus/");
		switchingTab(secondTab);
		launchURL("https://www.centrum.com/products/vitamin-packs/men-30-plus/");
	}


	@Test(priority = 0, enabled = true)
	private void cookieButton() throws Exception {
		vp = new CentrumVitaminPacksMen30PlusPage();
		switchingTab(firstTab);
		vp.clickCookieBtn();
		vp.clickGigyaForm();
		switchingTab(secondTab);
