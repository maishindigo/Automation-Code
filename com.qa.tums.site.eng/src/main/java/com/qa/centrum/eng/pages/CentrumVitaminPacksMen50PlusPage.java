...
public class CentrumVitaminPacksMen50PlusPage extends BaseClass{
	
	public CentrumVitaminPacksMen50PlusPage() {
	...
	@FindBy(xpath = "//p[text()='Centrum Wellness Packs Men 50+']")
	...
	@FindBy(xpath = "//a[@data-gtm-product-name='Centrum Daily Wellness Packs Men 60+']")
