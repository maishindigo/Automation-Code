...
public class CentrumSpecialistEnergyMultivitaminPage extends BaseClass{
	
	public CentrumSpecialistEnergyMultivitaminPage() {
	...
	@FindBy(xpath = "//p[text()='Specialist Energy']")
	...
	@FindBy(xpath = "//div[@class='box component section bg-color-white border border-color-gray-300 rounded p-d-x-1 p-d-y-1 p-m-1 anchor-box f-20-29 f-30-39 f-40-49 f-adults f-capsule f-energy f-general-wellness f-heart f-male f-muscle-function f-seniors f-young-adults filter-item product-card product-teal box_1938611159_copy_']")
	private static WebElement relatedProductOne;
	
	@FindBy(xpath = "//div[@class='box component section bg-color-white border border-color-gray-300 rounded p-d-x-1 p-d-y-1 p-m-1 anchor-box product-card product-orange box_1938611159_copy_']")
	private static WebElement relatedProductTwo;
	
	@FindBy(xpath = "//div[@class='box component section bg-color-white border border-color-gray-300 rounded p-d-x-1 p-d-y-1 p-m-1 anchor-box f-20-29 f-30-39 f-40-49 f-50-59 f-60-100 f-adults f-heart f-immunity f-non-binary f-seniors f-tablets f-young-adults filter-item product-card first odd last']")
	private static WebElement relatedProductThree;
	
	@FindBy(xpath = "//div[@class='box component section bg-color-white border border-color-gray-300 rounded p-d-x-1 p-d-y-1 p-m-1 anchor-box product-card product-green box_1938611159_copy_']")
	private static WebElement relatedProductFour;
	
	@FindBy(xpath = "//a[@data-gtm-product-name='Centrum Whole Food Multivitamin Men 60 CT']")
	private static WebElement buyNowOne;
	
	@FindBy(xpath = "//a[@data-gtm-product-name='Centrum Energy Whole Food Blend Supplement']")
	private static WebElement buyNowTwo;
	
	@FindBy(xpath = "//a[@data-gtm-product-name='Centrum Specialist Heart Health Multivitamin']")
	private static WebElement buyNowThree;
	
	@FindBy(xpath = "//a[@data-gtm-product-name='Centrum Mental Focus Whole Food Blend Supplement']")
	private static WebElement buyNowFour;
	
	@FindBy(xpath = "//h2[text()='Centrum Whole Food Multivitamin Men 60 CT']")
	private static WebElement buyNowCloseOne;
	
	@FindBy(xpath = "//h2[text()='Centrum Energy Whole Food Blend Supplement']")
	private static WebElement buyNowCloseTwo;
	
	@FindBy(xpath = "//h2[text()='Centrum Specialist Heart Health Multivitamin']")
	private static WebElement buyNowCloseThree;
	
	@FindBy(xpath = "//h2[text()='Centrum Mental Focus Whole Food Blend Supplement']")
	...
	public void clickRelatedProductOne()throws Exception {
		...
		if (title.contains(error)) {
			Assert.assertTrue(false, "Title Contains 404 Error");
		}
	}
