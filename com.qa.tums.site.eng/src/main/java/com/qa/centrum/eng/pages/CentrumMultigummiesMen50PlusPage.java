...
public class CentrumMultigummiesMen50PlusPage extends BaseClass{
	
	public CentrumMultigummiesMen50PlusPage() {
	...
	@FindBy(xpath = "//p[text()='MultiGummies Men 50+']")
	...
	@FindBy(xpath = "//div[@class='box component section bg-color-white border border-color-gray-300 rounded p-d-x-1 p-d-y-1 p-m-1 anchor-box f-50-59 f-60-100 f-bone-health f-brain-function f-general-wellness f-gummy f-heart f-non-binary f-seniors filter-item product-card product-orange first odd last']")
	...
	@FindBy(xpath = "//div[@class='box component section bg-color-white border border-color-gray-300 rounded p-d-x-1 p-d-y-1 p-m-1 anchor-box f-50-59 f-60-100 f-brain-function f-energy f-eye-health f-general-wellness f-heart f-male f-seniors f-tablets filter-item product-blue product-card box_1938611159_copy_']")
	private static WebElement relatedProductFour;
	
	@FindBy(xpath = "//a[@data-gtm-product-name='Centrum MultiGummies Adult 50+  90CT']")
	private static WebElement buyNowOne;
	
	@FindBy(xpath = "//a[@data-gtm-product-name='Centrum MultiGummies Men']")
	...
	@FindBy(xpath = "//a[@data-gtm-product-name='Centrum MultiI+Omega Men 50+ 60CT']")
	private static WebElement buyNowFour;
	
	@FindBy(xpath = "//h2[text()='Centrum MultiGummies ADULTS 50+  90CT']")
	...
	@FindBy(xpath = "//h2[text()='Centrum  MULTI+OMEGA MEN 50+ 60CT']")
