...
public class Women20Plus extends BaseClass{
	public Women20Plus() {
	...
	@FindBy(xpath = "//p[text()='Centrum Wellness Packs Women 20+']")
	...
	@FindBy(xpath = "//div[contains(@class,'box component section bg-color-white border border-color-gray-300 rounded p-d-x-1 p-d-y-1 p-m-1 anchor-box f-30-39 f-adults f-bone-health f-capsule f-eye-health f-female f-hair-skin-nails f-heart f-tablets f-young-adults filter-item product-card product-purple first odd last')]")
