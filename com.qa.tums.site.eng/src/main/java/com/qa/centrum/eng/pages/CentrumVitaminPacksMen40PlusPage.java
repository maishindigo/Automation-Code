...
public class CentrumVitaminPacksMen40PlusPage extends BaseClass{

	public CentrumVitaminPacksMen40PlusPage() {
	...
	@FindBy(xpath = "//p[text()='Centrum Wellness Packs Men 40+']")
	...
	@FindBy(xpath = "//a[@data-gtm-product-name='Centrum Daily Wellness Packs Men 50+']")
