...
public class CentrumGummyCalmResetforAdults extends BaseClass {
	public CentrumGummyCalmResetforAdults() {
	...
	@FindBy(xpath = "//h2[text()='Centrum Adult Gummy Calm & Reset 50ct']")
	...
	@FindBy(xpath = "//p[text()='Gummy Calm & Reset']")
	private static WebElement txtWomenTropicalFruitFlavors;
	...
	@FindBy(xpath = "//div[contains(@class,'box component section bg-color-white border border-color-gray-300 rounded p-d-x-1 p-d-y-1 p-m-1 anchor-box f-20-29 f-30-39 f-40-49 f-50-59 f-60-100 f-adults f-gummy f-mental f-non-binary f-seniors f-young-adults filter-item product-card product-teal first odd last')]")
	private static WebElement relatedProductOne;
	
	@FindBy(xpath = "//div[contains(@class,'box component section bg-color-white border border-color-gray-300 rounded p-d-x-1 p-d-y-1 p-m-1 anchor-box f-20-29 f-30-39 f-40-49 f-50-59 f-60-100 f-adults f-gummy f-non-binary f-seniors f-sleep f-young-adults filter-item product-card product-purple first odd last')]")
	private static WebElement relatedProductTwo;
	
	@FindBy(xpath = "//div[contains(@class,'box component section bg-color-white border border-color-gray-300 rounded p-d-x-1 p-d-y-1 p-m-1 anchor-box f-20-29 f-30-39 f-40-49 f-50-59 f-60-100 f-adults f-capsule f-energy f-non-binary f-seniors f-young-adults filter-item product-card product-pink first odd last')]")
	private static WebElement relatedProductThree;
	
	@FindBy(xpath = "//div[contains(@class,'box component section f-collagen-formation f-joint-health bg-color-white border border-color-gray-300 rounded p-d-x-1 p-d-y-1 p-m-1 anchor-box f-20-29 f-30-39 f-40-49 f-50-59 f-60-100 f-adults f-bone-health f-capsule f-non-binary f-seniors f-young-adults filter-item product-card product-green first odd last')]")
	...
	public boolean txtProductVerification() throws Exception{
		boolean elementIsDisplayed = elementIsDisplayed(txtWomenTropicalFruitFlavors);
