...
public class CentrumVitaminPacksMen30PlusPage extends BaseClass{

	
	public CentrumVitaminPacksMen30PlusPage() {
	...
	@FindBy(xpath = "//p[text()='Centrum Wellness Packs Men 30+']")
	...
	@FindBy(xpath = "//a[@data-gtm-product-name='Centrum Daily Wellness Packs Men 40+']")
	private static WebElement buyNowOne;
	
	@FindBy(xpath = "//a[@data-gtm-product-name='Centrum Daily Wellness Packs Men 20+']")
