...
public class CentrumSilverMen50PlusPage extends BaseClass{


	public CentrumSilverMen50PlusPage() {
	...
	@FindBy(xpath = "//p[text()='Silver Men']")
	private static WebElement txtSilverMen;
	...
	@FindBy(xpath = "//div[@class='box component section bg-color-white border border-color-gray-300 rounded p-d-x-1 p-d-y-1 p-m-1 anchor-box f-50-59 f-60-100 f-brain-function f-eye-health f-general-wellness f-heart f-male f-muscle-function f-seniors f-tablets filter-item product-blue product-card first odd last']")
	...
	public boolean txtProductVerification() throws Exception{
		boolean elementIsDisplayed = elementIsDisplayed(txtSilverMen);
