...
public class CentrumVitaminPacksMen20PlusPage extends BaseClass{
	
	public CentrumVitaminPacksMen20PlusPage() {
	...
	@FindBy(xpath = "//p[text()='Wellness Packs Men 20+']")
	...
	@FindBy(xpath = "//div[@class='box component section bg-color-white border border-color-gray-300 rounded p-d-x-1 p-d-y-1 p-m-1 anchor-box f-20-29 f-30-39 f-40-49 f-50-59 f-60-100 f-adults f-energy f-general-wellness f-gummy f-immunity f-male f-muscle-function f-organic f-physical-stress-relief f-seniors f-young-adults filter-item product-blue product-card first odd last']")
	private static WebElement relatedProductFour;
	
	@FindBy(xpath = "//a[@data-gtm-product-name='Centrum Daily Wellness Packs Men 30+']")
	...
	@FindBy(xpath = "//a[@data-gtm-product-name='CENTRUM ORGANIC GUMMY MEN']")
	...
	@FindBy(xpath = "//h2[text()='CENTRUM ORGANIC GUMMY MEN']")
