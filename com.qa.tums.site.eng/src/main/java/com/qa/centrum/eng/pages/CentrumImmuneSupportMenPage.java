...
public class CentrumImmuneSupportMenPage extends BaseClass{
	
	public CentrumImmuneSupportMenPage() {
	...
	@FindBy(xpath = "//a[@href='#tab-350233941-1']")
	...
	@FindBy(xpath = "//a[@href='#tab-350233941-2']")
	...
	@FindBy(xpath = "//a[@href='#tab-350233941-3']")
	...
	@FindBy(xpath = "//p[text()='Minis Immune Support Men']")
