...
public class CentrumVitaminPacksWomen50PlusPage extends BaseClass{
	
	public CentrumVitaminPacksWomen50PlusPage() {
	...
	@FindBy(xpath = "//p[text()='Centrum Wellness Packs Women 50+']")
	...
	@FindBy(xpath = "//div[@class='box component section bg-color-white border border-color-gray-300 rounded p-d-x-1 p-d-y-1 p-m-1 anchor-box f-40-49 f-adults f-bone-health f-capsule f-female f-hair-skin-nails f-immunity f-tablets filter-item last-down product-card product-purple first odd last']")
	...
	@FindBy(xpath = "//a[@data-gtm-product-name='Centrum Daily Wellness Packs Women 40+']")
	private static WebElement buyNowOne;
	
	@FindBy(xpath = "//a[@data-gtm-product-name='Centrum Daily Wellness Packs Women 60+']")
