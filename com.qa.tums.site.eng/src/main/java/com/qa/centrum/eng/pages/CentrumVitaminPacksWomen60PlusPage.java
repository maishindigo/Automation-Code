...
public class CentrumVitaminPacksWomen60PlusPage extends BaseClass{
	
	public CentrumVitaminPacksWomen60PlusPage() {
	...
	@FindBy(xpath = "//p[text()='Centrum Wellness Packs Women 60+']")
