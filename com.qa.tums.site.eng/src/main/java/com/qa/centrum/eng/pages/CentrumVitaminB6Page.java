...
public class CentrumVitaminB6Page extends BaseClass {

	public CentrumVitaminB6Page() {
	...
	private static WebElement heartHealth;

	@FindBy(xpath = "(//div[contains(@class,'box component section bg-color-white rounded')])[2]")
	private static WebElement energy;

	@FindBy(xpath = "(//div[contains(@class,'box component section bg-color-white rounded')])[3]")
	private static WebElement brainHealth;

	@FindBy(xpath = "(//h2[@style='text-align: center;'])[2]")
	private static WebElement scrollToArticle;

	@FindBy(xpath = "//a[@href='/learn/articles/nutrients-and-routine/top-5-nutrients-for-men-over-50/']")
	private static WebElement articleOne;

	@FindBy(xpath = "//a[@href='/learn/articles/nutrients-and-routine/5-vitamins-for-women-over-50/']")
	...
	public void clickHeartHealthFeatured() throws Exception {
		elementClick(featruedProduct);
		scrollDownUsingElement(heartHealth);
		elementClick(heartHealth);
	}
