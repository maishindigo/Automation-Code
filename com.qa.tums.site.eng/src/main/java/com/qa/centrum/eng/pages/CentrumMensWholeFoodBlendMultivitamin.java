...
public class CentrumMensWholeFoodBlendMultivitamin extends BaseClass{
	public CentrumMensWholeFoodBlendMultivitamin() {
	...
	@FindBy(xpath = "//p[text()='Men’s Whole Food Blend Multivitamins']")
	...
	@FindBy(xpath = "//div[contains(@class,'box component section bg-color-white border border-color-gray-300 rounded p-d-x-1 p-d-y-1 p-m-1 anchor-box f-20-29 f-30-39 f-40-49 f-adults f-bone-health f-capsule f-energy f-female f-general-wellness f-immunity f-seniors f-young-adults filter-item product-card product-pink first odd last')]")
	private static WebElement relatedProductOne;
	
	@FindBy(xpath = "//div[contains(@class,'box component section bg-color-white border border-color-gray-300 rounded p-d-x-1 p-d-y-1 p-m-1 anchor-box product-card product-orange box_1938611159_copy_')]")
	private static WebElement relatedProductTwo;
	
	@FindBy(xpath = "//div[contains(@class,'box component section bg-color-white border border-color-gray-300 rounded p-d-x-1 p-d-y-1 p-m-1 anchor-box product-card product-green box_1938611159_copy_')]")
	private static WebElement relatedProductThree;
	
	@FindBy(xpath = "//div[contains(@class,'box component section bg-color-white border border-color-gray-300 rounded p-d-x-1 p-d-y-1 p-m-1 anchor-box product-card product-purple box_1938611159_copy_')]")
