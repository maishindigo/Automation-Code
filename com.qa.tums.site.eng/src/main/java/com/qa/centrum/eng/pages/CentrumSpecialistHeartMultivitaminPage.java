...
public class CentrumSpecialistHeartMultivitaminPage extends BaseClass{
	
	public CentrumSpecialistHeartMultivitaminPage() {
	...
	@FindBy(xpath = "//p[text()='Specialist Heart Health Multivitamin']")
	...
	@FindBy(xpath = "//div[@class='box component section bg-color-white border border-color-gray-300 rounded p-d-x-1 p-d-y-1 p-m-1 anchor-box f-20-29 f-30-39 f-40-49 f-50-59 f-60-100 f-adults f-energy f-non-binary f-seniors f-tablets f-young-adults filter-item product-card product-orange box_1938611159_copy_']k")
	...
	@FindBy(xpath = "//a[@data-gtm-product-name='Centrum Silver Men 40ct']")
