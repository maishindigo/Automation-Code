...
public class CentrumMultigummiesWomenPage extends BaseClass{
	
	
	public CentrumMultigummiesWomenPage() {
	...
	@FindBy(xpath = "//p[text()='MultiGummies Women']")
	...
	@FindBy(xpath = "//a[@data-gtm-product-name='Centrum MultiGummies Multi+ Beauty']")
	...
	@FindBy(xpath = "//h2[text()='Centrum MultiGummies Multi+ Beauty']")
