...
public class CentrumIodinePage extends BaseClass{
	
	public CentrumIodinePage() {
	...
	@FindBy(xpath = "//a[@href='/learn/articles/how-supplements-work/are-the-nutrients-in-supplements-absorbed/']")
