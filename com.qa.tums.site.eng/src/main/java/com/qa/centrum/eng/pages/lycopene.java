...
public class lycopene extends BaseClass {
	public lycopene() {
	...
	public void clickLutein() throws Exception {
		scrollDownUsingElement(lutein);
		clickElementUsingJavaScript(lutein);
	}
	public void clickLutein_Learn() throws Exception {
		scrollDownUsingElement(lutein_Learn);
		clickElementUsingJavaScript(lutein_Learn);
	}
	...
	public void clickVitamin_E_Learn() throws Exception {
