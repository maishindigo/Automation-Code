...
public class CentrumVitaminPacksMen60PlusPage extends BaseClass{

	public CentrumVitaminPacksMen60PlusPage() {
	...
	@FindBy(xpath = "//p[text()='Centrum Wellness Packs Men 60+']")
