...
public class centrumMiniImmunSupportWomen extends BaseClass{
	public centrumMiniImmunSupportWomen() {
	...
	@FindBy(xpath = "//h2[text()='Centrum Minis Women Immune Support 160ct']")
	...
	@FindBy(xpath = "//p[text()='Minis Immune Support Women']")
	private static WebElement txtMinisImmuneSupportWomen;
	...
	public boolean txtProductVerification() throws Exception{
		boolean elementIsDisplayed = elementIsDisplayed(txtMinisImmuneSupportWomen);
