...
public class Women30Plus extends BaseClass{
	public Women30Plus() {
	...
	@FindBy(xpath = "//div[contains(@class,'box component section bg-color-white border border-color-gray-300 rounded p-d-x-1 p-d-y-1 p-m-1 anchor-box f-20-29 f-capsule f-eye-health f-female f-hair-skin-nails f-heart f-tablets f-young-adults filter-item product-card product-purple first odd last')]")
	private static WebElement relatedProductOne;
	
	@FindBy(xpath = "//div[contains(@class,'box component section bg-color-white border border-color-gray-300 rounded p-d-x-1 p-d-y-1 p-m-1 anchor-box f-40-49 f-adults f-bone-health f-capsule f-female f-hair-skin-nails f-immunity f-tablets filter-item last-down product-card product-purple first odd last')]")
