...
public class CentrumVitaminPacksWomen40PlusPage extends BaseClass{

	
	public CentrumVitaminPacksWomen40PlusPage() {
	...
	@FindBy(xpath = "//p[text()='Centrum Wellness Packs Women 40+']")
	...
	@FindBy(xpath = "//div[@class='box component section bg-color-white border border-color-gray-300 rounded p-d-x-1 p-d-y-1 p-m-1 anchor-box f-30-39 f-adults f-bone-health f-capsule f-eye-health f-female f-hair-skin-nails f-heart f-tablets f-young-adults filter-item product-card product-purple first odd last']")
	private static WebElement relatedProductOne;
	
	@FindBy(xpath = "//div[@class='box component section bg-color-white border border-color-gray-300 rounded p-d-x-1 p-d-y-1 p-m-1 anchor-box f-50-59 f-bone-health f-capsule f-female f-muscle-function f-seniors f-tablets filter-item product-card product-purple first odd last']")
	...
	@FindBy(xpath = "//div[@class='box component section bg-color-white border border-color-gray-300 rounded p-d-x-1 p-d-y-1 p-m-1 anchor-box f-20-29 f-30-39 f-40-49 f-adults f-energy f-female f-general-wellness f-gummy f-hair-skin-nails f-immunity f-metabolism f-young-adults filter-item product-card product-purple box_1938611159_copy_']")
	private static WebElement relatedProductFour;
	
	@FindBy(xpath = "//a[@data-gtm-product-name='Centrum Daily Wellness Packs Women 30+']")
	private static WebElement buyNowOne;
	
	@FindBy(xpath = "//a[@data-gtm-product-name='Centrum Daily Wellness Packs Women 50+']")
	private static WebElement buyNowTwo;
	
	@FindBy(xpath = "//a[@data-gtm-product-name='Centrum Women 40CT']")
	private static WebElement buyNowThree;
	
	@FindBy(xpath = "//a[@data-gtm-product-name='Centrum MultiGummies Women']")
	...
	@FindBy(xpath = "//h2[text()='Centrum MultiGummies Women']")
