...
public class CentrumMultiOmega3Women50Page extends BaseClass{
	
	public CentrumMultiOmega3Women50Page() {
	...
	@FindBy(xpath = "//p[text()='Multi + Omega-3 Women 50+']")
	...
	@FindBy(xpath = "//div[@class='box component section bg-color-white border border-color-gray-300 rounded p-d-x-1 p-d-y-1 p-m-1 anchor-box f-20-29 f-30-39 f-40-49 f-adults f-bone-health f-energy f-general-wellness f-gummy f-heart f-non-binary f-young-adults filter-item product-card first odd last']")
	...
	@FindBy(xpath = "//a[@data-gtm-product-name='Centrum MultiGummies Multi+ Omega-3']")
	...
	@FindBy(xpath = "//h2[text()='Centrum MultiGummies Multi+ Omega-3']")
