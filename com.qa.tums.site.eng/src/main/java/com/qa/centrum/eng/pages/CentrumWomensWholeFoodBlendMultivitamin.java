...
public class CentrumWomensWholeFoodBlendMultivitamin extends BaseClass {
	public CentrumWomensWholeFoodBlendMultivitamin() {
	...
	@FindBy(xpath = "//h2[text()='Centrum Whole Food Multivitamin Womens 60 CT']")
	...
	@FindBy(xpath = "//p[text()='Women’s Whole Food Blend Multivitamins']")
	...
	@FindBy(xpath = "//div[contains(@class,'box component section bg-color-white border border-color-gray-300 rounded p-d-x-1 p-d-y-1 p-m-1 anchor-box product-card box_1938611159_copy_')]")
