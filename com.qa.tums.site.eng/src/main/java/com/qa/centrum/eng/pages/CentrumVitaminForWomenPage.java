...
public class CentrumVitaminForWomenPage extends BaseClass{
	
	public CentrumVitaminForWomenPage() {
	...
	private static WebElement womensVitaminLinkOne;
	
	@FindBy(xpath = "//u[text()='Centrum® vitamins formulated especially for women']")
	private static WebElement womensVitaminLinkTwo;
	...
	public void clickMulitivitaminLink() throws Exception {
		scrollDownUsingElement(multivitaminLink);
		clickElementUsingJavaScript(multivitaminLink);
	}
	
	public void clickWomensVitaminLinkOne() throws Exception{
		scrollDownUsingElement(womensVitaminLinkOne);
		clickElementUsingJavaScript(womensVitaminLinkOne);
	}
	
	public void clickWomensVitaminLinkTwo() throws Exception{
		scrollDownUsingElement(womensVitaminLinkTwo);
		clickElementUsingJavaScript(womensVitaminLinkTwo);
	}
