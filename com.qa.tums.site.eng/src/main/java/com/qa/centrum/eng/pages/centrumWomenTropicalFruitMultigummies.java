...
public class centrumWomenTropicalFruitMultigummies extends BaseClass {
	public centrumWomenTropicalFruitMultigummies() {
	...
	@FindBy(xpath = "//p[text()='Women Tropical Fruit Flavors']")
	...
	@FindBy(xpath = "//div[contains(@class,'box component section bg-color-white border border-color-gray-300 rounded p-d-x-1 p-d-y-1 p-m-1 anchor-box f-20-29 f-30-39 f-40-49 f-50-59 f-60-100 f-adults f-female f-general-wellness f-gummy f-hair-skin-nails f-immunity f-metabolism f-organic f-physical-stress-relief f-seniors f-young-adults filter-item product-card product-purple first odd last')]")
	private static WebElement relatedProductTwo;
	
	@FindBy(xpath = "//div[contains(@class,'box component section bg-color-white border border-color-gray-300 rounded p-d-x-1 p-d-y-1 p-m-1 anchor-box f-20-29 f-30-39 f-40-49 f-50-59 f-60-100 f-adults f-bone-health f-energy f-general-wellness f-gummy f-hair-skin-nails f-immunity f-non-binary f-seniors f-young-adults filter-item product-card product-pink box_1938611159_copy_')]")
