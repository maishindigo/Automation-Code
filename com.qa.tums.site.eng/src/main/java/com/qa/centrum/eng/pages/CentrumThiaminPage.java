...
public class CentrumThiaminPage extends BaseClass{
	
	public CentrumThiaminPage() {
	...
	@FindBy(xpath = "//a[@href='/learn/articles/health-and-lifestyle-tips/over-50-what-your-body-needs-more-of-now/']")
	private static WebElement articleThree;
	
	@FindBy(xpath = "//a[@href='/learn/articles/health-and-lifestyle-tips/whats-good-for-the-heart-is-good-for-the-brain/']")
	...
	private static WebElement productAdultsFiftyPlus;
	...
	public void clickGigyaForm() {
		...
		public void clickProductAdultsFiftyPlus() throws Exception {
			elementClick(featruedProduct);
			scrollDownUsingElement(productAdultsFiftyPlus);
			elementClick(productAdultsFiftyPlus);
		}
