...
public class CentrumAdultGummyRestRejuvenatePage extends BaseClass{

	public CentrumAdultGummyRestRejuvenatePage() {
	...
	@FindBy(xpath = "//p[text()='Gummy Rest & Rejuvenate']")
	...
	@FindBy(xpath = "//div[@class='box component section bg-color-white border border-color-gray-300 rounded p-d-x-1 p-d-y-1 p-m-1 anchor-box f-20-29 f-30-39 f-40-49 f-50-59 f-60-100 f-adults f-capsule f-energy f-non-binary f-seniors f-young-adults filter-item product-card product-pink first odd last']")
	...
	@FindBy(xpath = "//a[@data-gtm-product-name='Centrum Adult Gummy Calm & Reset 50ct']")
	...
	@FindBy(xpath = "//a[@data-gtm-product-name='Centrum Adult Energy & Vitality Capsule 50ct']")
	...
	@FindBy(xpath = "//h2[text()='Centrum Adult Energy & Vitality Capsule 50ct']")
