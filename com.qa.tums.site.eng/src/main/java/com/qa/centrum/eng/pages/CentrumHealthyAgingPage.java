...
public class CentrumHealthyAgingPage extends BaseClass{

	public CentrumHealthyAgingPage() {
	...
	@FindBy(xpath = "//u[text()='absorb vitamin B12 from food']")
	private static WebElement vitaminB12Link;
	
	@FindBy(xpath = "//span[text()='Vitamin D']")
	private static WebElement vitaminDLinkOne;
	
	@FindBy(xpath = "//a[text()='help maintain strong bones.']")
	private static WebElement vitaminDLinkTwo;
	
	@FindBy(xpath = "//a[text()='Learn With Centrum']")
	private static WebElement magnesiumLink;
	...
	public void clickMagnesiumLink() throws Exception{
		scrollDownUsingElement(magnesiumLink);
		clickElementUsingJavaScript(magnesiumLink);
	}
