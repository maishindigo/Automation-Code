...
public class CentrumCopperPage extends BaseClass {
	
	public CentrumCopperPage() {
	...
	private static WebElement productSilverMen;
	...
	public void clickGigyaForm() {
		...
		public void clickProductSilverMen() throws Exception {
			elementClick(featruedProduct);
			scrollDownUsingElement(productMen);
			elementClick(productSilverMen);
		}
